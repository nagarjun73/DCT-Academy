...
const displayDate = function() {
    dataRes.innerHTML = "";
    const startTimeFormat = (0, _dateFns.format)(new Date(startTime.value), "dd.MM.yyyy hh:mm");
    const endTimeFormat = (0, _dateFns.format)(new Date(endTime.value), "dd.MM.yyyy hh:mm");
    let slot = Number(selectSlot.value);
    const startTimeHours = (0, _dateFns.format)(new Date(startTime.value), "hh");
    const endTimehours = (0, _dateFns.format)(new Date(endTime.value), "hh");
    const startTimeMinutes = (0, _dateFns.format)(new Date(startTime.value), "mm");
    const endTimeMinutes = (0, _dateFns.format)(new Date(endTime.value), "mm");
    const startTimeDay = (0, _dateFns.format)(new Date(startTime.value), "dd");
    const endTimeDay = (0, _dateFns.format)(new Date(endTime.value), "dd");
    ...
    for(let i = 0; i < totalSlot; i++){
        let add = (0, _dateFns.addMinutes)(resultArr[i], slot);
        resultArr.push(add);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fZ0OC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/toInteger/index.js":"f7kKX","../addMilliseconds/index.js":"7Tp9s","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lnm6V":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lmKb7","adjPd"], "adjPd", "parcelRequire45c9")

//# sourceMappingURL=chargingSlots.63aff760.js.map
